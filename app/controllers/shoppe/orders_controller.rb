module Shoppe
  class OrdersController < Shoppe::ApplicationController
    ...
    def create_customer(order)
      unless Shoppe::Customer.exists?(first_name: order.first_name, last_name: order.last_name)
        customer = Shoppe::Customer.new
        customer.first_name = order.first_name
        customer.last_name = order.last_name
        customer.company = order.company
        customer.email = order.email_address
